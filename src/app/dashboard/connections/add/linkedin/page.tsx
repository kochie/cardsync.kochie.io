...
import { addLinkedinCookie } from "@/actions/connections/linkedin";
...
export default function LinkedInConnectionPage() {
  ...
  const handleConnect = async () => {
    ...
    // Simulate API call
    try {
      const {error} = await addLinkedinCookie(cookieValue, connectionName);
      if (error) {
        console.error("Failed to add LinkedIn cookie:", error);
      }
    } finally {
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow border border-gray-200">
          <div className="p-6 border-b">
            ...
            <div className="text-gray-500">
              LinkedIn doesn&apos;t provide an official API for contacts.
              We&apos;ll use your session cookie to sync your connections.
            </div>
          </div>
          <div className="p-6 space-y-4">
            <div>
              ...
              <Text>
                Your session cookie is encrypted and only used to sync your
                LinkedIn connections. We never store your credentials or share
                your data.
              </Text>
            </div>
            ...
            <Field>
              <Label htmlFor="jsession-cookie" className="text-sm font-medium">
                JSESSION ID
              </Label>
            ...
            <Field>
              <Label htmlFor="linkedin-cookie" className="text-sm font-medium">
                LinkedIn Session ID
              </Label>
          ...
          <div className="flex justify-between items-center p-6 border-t">
            ...
            <Button
              ...
              disabled={!cookieValue.trim() || isSubmitting}
            >
