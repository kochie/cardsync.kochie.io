...
import { ArrowLeft, Facebook, Github, Loader2, Mail, Users } from "lucide-react"
          ...
          <div className="hidden md:flex flex-col items-center justify-center p-6">
            ...
            <div className="text-center mt-6">
              ...
              <p className="text-gray-600 max-w-md">
                Log in to sync your contacts across all platforms and keep your network organized.
              </p>
            </div>
          </div>
