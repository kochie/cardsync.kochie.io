...
>) {
  ...
  return (
    <Headless.ComboboxOption
      ...
      className={clsx(
        // Basic layout
        "grid w-full cursor-default grid-cols-[1fr_--spacing(5)] items-baseline gap-x-2 rounded-lg py-2.5 pr-2 pl-3.5 sm:grid-cols-[1fr_--spacing(4)] sm:py-1.5 sm:pr-2 sm:pl-3",
        // Typography
